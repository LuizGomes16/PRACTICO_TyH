...
let v_TKN  = CrearToken();               //id del token, el que es transferido de transaccion a otra. El coinbase se guarda el token.
...
while (contador <= 1) {
   ...
   // v_st   = "frweg9080";                  //string de la transaccion simple no aleatorio, para hashearla
   v_st = GenerarStrAleatorio(12);           //string aleatorio de la transaccion simple, para hashearla
